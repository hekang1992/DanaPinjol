...
class MineLogoutView: BaseView {
    ...
    private lazy var bgImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "out_acd_image".localized)
    ...
    private func setupConstraints() {
        containerView.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: 324.pix(), height: 323.pix()))
        }
